            ...
            <Router>
                        ...
                        <div className={'container'}>
                            ...
                            <div className={'navigation'}>
                                <div className={'aboutMe'}>
                                    <a href={'#'} className={'navLink'} onClick={this.toggleAboutMeDropdown}>Про мене</a>
                                ...
                                <div className={'science'}>
                                    <a className={'navLink'} href={'#'} onClick={this.toggleScienceDropdown}>Наука</a>
                                ...
                                <div className={'patient'}>
                                    <a href={'#'} className={'navLink'} onClick={this.togglePatientDropdown}>Паціентам</a>
                                ...
                                <a href={'#'} onClick={this.toggleCourseDropdown}><Link className={'navLink'} to={'/course'}>Напрямок</Link></a>
                                <a href={'#'} onClick={this.toggleContactDropdown}><Link className={'navLink'} to={"/contacts"}>Контакти</Link></a>
                                <a href={'#'} onClick={this.toggleMainDropdown}><Link className={'navLink'} to={"/"}>Головна</Link></a>
                            </div>
                        </div>
                    </div>
                </header>
                ...
                <footer>
                        ...
                        <div className={'container'}>
                            <div className={'footerInfo'}>
                                ...
                                <div className={'iconGroup'}>
                                    ...
                                    <a href={"#"} className={'navLink'}>38 (098) 8535361</a>
                                </div>
                                <div className={'iconGroup'}>
                                    <svg width="15" height="15" fill="currentColor"
                                         className={'icon'} viewBox="0 0 16 16">
                                ...
                                <div className={'iconGroup'}>
                                    ...
                                    <a href={'mailto:doctor@gmail.com'} className={'navLink'}>doctor@gmail.com</a>
                                </div>
                    ...
                    <div className={'footerBott'}>
                        <div className={'container'}>
                            2023 Шевченко Станислав Ростиславович | Хірург у м. Київ. Всі права захищено.
                        </div>
                    </div>
                </footer>
            </Router>
