...
class HeaderUa extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
        ...
        <header>
            <div className={'topHeader'}>
                <div className={'container'}>
                    ...
                    <div className={'local'}>
                        <a><Link to={'/ru'}>Рус</Link></a>
                        <a><Link to={'/'} className={'Active'}>Укр</Link></a>
                    </div>
                </div>
            </div>
            <div className={'mainHeader'}>
                <div className={'container'}>
                    <a className={'logo'} href={'#'}><Link to={"/"}><img className={'logo'} src={'/images/logo2.png'} alt={'logo'}/></Link></a>
