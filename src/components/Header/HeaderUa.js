        ...
        <header>
            <div className={'topHeader'}>
                <div className={'container'}>
                    <a href={'tel:+380504231417'} className={`phoneElement`}>
                    ...
                    <a href={'mailto:dr_shevchenko_rs@ukr.net'} className={`emailElement`}>
                            <svg width="15" height="15" fill="currentColor"
                        ...
                        dr_shevchenko_rs@ukr.net
                    </a>
                    <a href={'https://www.google.com/maps/place/49%C2%B058\'43.8%22N+36%C2%B017\'28.4%22E/@49.978834,36.291217,754m/data=!3m2!1e3!4b1!4m4!3m3!8m2!3d49.978834!4d36.291217?entry=ttu&g_ep=EgoyMDI1MDIwNS4xIKXMDSoASAFQAw%3D%3D'} className={'addressEl'}>
                            <svg width="15" height="15" fill="currentColor"
                                 className="icon" viewBox="0 0 16 16">
                                <path
                    ...
                    <div className={'socialGroup'}>
                        <a href={'https://t.me/+380504231417'}>
                            <svg width="15" height="15" fill="currentColor"
                                 className="icon" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href={'viber://chat?number=380504231417'}>
                                    ...
                                    <div className="dropdown-content">
                                        <ul className={'dropdownBlock'}>
                                            <li onClick={() =>{ toggleAboutMeDropdown(); toggleBurger();}}>
                                                <Link to="about/basic-info">Загальна інформація</Link>
                                            </li>
                                            <li onClick={() => { toggleAboutMeDropdown(); toggleBurger();}}>
                                                <Link to="about/certificates">Сертифікати</Link>
                                            </li>
                                        </ul>
                                    </div>
                                )}
                                    ...
                                    <div className="dropdown-content">
                                        <ul className={'dropdownBlock'}>
                                            <li onClick={() => { togglePatientDropdown(); toggleBurger();}}>
                                                <Link to="patient/diagnostics">Діагностика</Link>
                                            </li>
                                        </ul>
                                    </div>
                                )}
